    ...
    def _build_surface(self, name: str) -> VolSurface:
        ...
        if spec.is_cross:
            ...
            atm = CrossAtmCurve(
                ...
                # Always the pair's own three coefficients.  CROSS_CORR is the
                # COS file's and never reaches the book (publish.py).
                correlation=CorrelationCurve(params.initial, params.long_term,
